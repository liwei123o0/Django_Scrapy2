...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        for (var a = [[gd(2017, 10, 1), 17], [gd(2017, 10, 2), 74], [gd(2017, 10, 3), 6], [gd(2017, 10, 4), 39], [gd(2017, 10, 5), 20], [gd(2017, 10, 6), 85], [gd(2017, 10, 7), 7]], b = [[gd(2017, 10, 1), 82], [gd(2017, 10, 2), 23], [gd(2017, 10, 3), 66], [gd(2017, 10, 4), 9], [gd(2017, 10, 5), 119], [gd(2017, 10, 6), 6], [gd(2017, 10, 7), 9]], d = [], e = [[0, 1], [1, 9], [2, 6], [3, 10], [4, 5], [5, 17], [6, 6], [7, 10], [8, 7], [9, 11], [10, 35], [11, 9], [12, 12], [13, 5], [14, 3], [15, 4], [16, 9]], f = 0; f <= 30; f++)d.push([new Date(Date.today().add(f).days()).getTime(), randNum() + f + f + 10]);
        var g = {
            series: {
                lines: {show: !1, fill: !0},
        ...
        $("#chart_plot_01").length && (console.log("Plot1"), $.plot($("#chart_plot_01"), [a, b], g)), $("#chart_plot_04").length && (console.log("Plot1"), $.plot($("#chart_plot_04"), [a, b], g)), $("#chart_plot_02").length && (console.log("Plot2"), $.plot($("#chart_plot_02"), [{
            label: "Email Sent",
            data: d,
            lines: {fillColor: "rgba(250, 202, 89, 0.12)"},
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        hideHover: "auto",
        lineColors: ["#26B99A", "#34495E", "#ACADAC", "#3498DB"],
        data: [{year: "2017", value: 20}, {year: "2013", value: 10}, {year: "2014", value: 5}, {
            year: "2015",
            value: 5
        }, {year: "2016", value: 20}],
        resize: !0
