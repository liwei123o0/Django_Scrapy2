...
!function (n) {
        ...
        if (e && !l(n, B)) {
            ...
            $(t, function (t, r) {
                ...
                c && !P[c] ? (f.res && (u = {
                    ...
                    absId: c,
                    hard: i > r
                }, e.depMs.push(a), e.depMkv[c] = a, o.push(c))) : a = {absId: c}, i > r && e.factoryDeps.push(u || a)
            }), e.state = B, s(n), m(o)
        }
    }
                ...
                if ($(i.factoryDeps, function (n) {
                    ...
                    try {
                        var a = p(o, {
                            ...
                            exports: i.exports,
                            module: i
                        }), u = i.factory, f = "function" == typeof u ? u.apply(n, a) : u;
    ...
    function A(n, e) {
        if (0 === n.indexOf(".")) {
            var t = e.split("/"), r = n.split("/"), i = t.length - 1, o = r.length, a = 0, u = 0;
    ...
    e.config = function (n) {
        if (n) {
            for (var e in C) {
                var t = n[e], r = C[e];
                if (t)if ("urlArgs" === e && "string" == typeof t)C.urlArgs["*"] = t; else if (r instanceof Array)r.push.apply(r, t); else if ("object" == typeof r)for (var i in t)r[i] = t[i]; else C[e] = t
            }
            k()
        }
    }, k();
