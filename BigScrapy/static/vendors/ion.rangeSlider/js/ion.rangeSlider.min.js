...
;(function (g) {
    ...
    r.prototype = {
        ...
        callOnFinish: function () {
            ...
            var b =
                this.options.min, d = this.options.max, c = b.toString().split(".")[1], e = d.toString().split(".")[1], f, l, g = 0, k = 0;
            ...
            var a = this.options, b = this.result, d = a.values, c = d.length, e, f;
        ...
        updateResult: function () {
            ...
            if (this.options.grid) {
                ...
                b = a.max - a.min;
                var c = a.grid_num, e = 0, f = 0, g = 4, h, k, m = 0, n = "";
                this.calcGridMargin();
