!function (t, e) {
    ...
    e.prototype.options.reference = {
        ...
        thingElem: null, init: function (e, n) {
            var i = this;
            this.notice, this.options, n.put_thing && (this.thingElem = t('<button style="float:right;" class="btn btn-default" type="button" disabled><i class="' + e.styles.athing + '" />&nbsp;' + n.labels.text + "</button>").appendTo(e.container), e.container.append('<div style="clear: right; line-height: 0;" />'), e.elem.on({
                ...
                var t = 0, n = setInterval(function () {
                    t += 10, 360 == t && (t = 0, clearInterval(n)), e.elem.css({
    ...
    }, t.extend(e.styling.jqueryui, {athing: "ui-icon ui-icon-refresh"}), t.extend(e.styling.bootstrap2, {athing: "icon-refresh"}), t.extend(e.styling.bootstrap3, {athing: "glyphicon glyphicon-refresh"}), t.extend(e.styling.fontawesome, {athing: "fa fa-refresh"})
});