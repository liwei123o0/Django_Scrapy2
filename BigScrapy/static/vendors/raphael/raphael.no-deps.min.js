!function t(e, r) {
    "object" == typeof exports && "object" == typeof module ? module.exports = r(require("eve")) : "function" == typeof define && define.amd ? define("Raphael", ["eve"], r) : "object" == typeof exports ? exports.Raphael = r(require("eve")) : e.Raphael = r(e.eve)
}(this, function (t) {
    return function (t) {
        function e(i) {
        ...
        i = [r(2)], n = function (t) {
            function e(r) {
                ...
                if (e.is(i[i.length - 1], "function")) {
                    var n = i.pop();
                    return w ? n.call(e._engine.create[F](e, i)) : t.on("raphael.DOMload", function () {
            ...
            function n(t, e, r) {
                function n() {
                    ...
                    return o[T](s) ? (i(l, s), r ? r(o[s]) : o[s]) : (l.length >= 1e3 && delete o[l.shift()], l.push(s), o[s] = t[F](e, a), r ? r(o[s]) : o[s])
                }
            ...
            function u(t, e, r, i, n, a, s, o) {
                if (!(Y(t, r) < G(n, s) || G(t, r) > Y(n, s) || Y(e, i) < G(a, o) || G(e, i) > Y(a, o))) {
                    ...
                    if (u) {
                        ...
                        if (!(p < +G(t, r).toFixed(2) || p > +Y(t, r).toFixed(2) || p < +G(n, s).toFixed(2) || p > +Y(n, s).toFixed(2) || d < +G(e, i).toFixed(2) || d > +Y(e, i).toFixed(2) || d < +G(a, o).toFixed(2) || d > +Y(a, o).toFixed(2)))return {
                            x: c,
                            y: f
                        }
                    }
            ...
            function p(t, r, i) {
                ...
                for (var s = l.apply(0, t), o = l.apply(0, r), h = Y(~~(s / 5), 1), c = Y(~~(o / 5), 1), f = [], p = [], d = {}, g = i ? 0 : [], x = 0; h + 1 > x; x++) {
            ...
            function b(r, i, n, a, s, o) {
                ...
                if (a)for (w = 0, B = Ne.length; B > w; w++) {
                    var _ = Ne[w];
                    if (_.el.id == i.id && _.anim == r) {
                        _.percent != n ? (Ne.splice(w, 1), u = 1) : h = _, i.attr(_.totalOrigin);
                        break
                    }
                } else a = +m;
                    ...
                    if (h)h.initstatus = a, h.start = new Date - h.ms * a; else {
                        for (var C in l)if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C)))switch (v[C] = i.attr(C), null == v[C] && (v[C] = ft[C]), m[C] = l[C], pt[C]) {
                            ...
                            case"colour":
                                ...
                                break;
                            case"path":
                                var A = Qt(v[C], m[C]), N = A[1];
                                for (v[C] = A[0], b[C] = [], w = 0, B = v[C].length; B > w; w++) {
                                    b[C][w] = [0];
                                    for (var E = 1, M = v[C][w].length; M > E; E++)b[C][w][E] = (N[w][E] - v[C][w][E]) / x
                                }
                                break;
                            case"transform":
                                var L = i._, F = le(L[C], m[C]);
                                if (F)for (v[C] = F.from, m[C] = F.to, b[C] = [], b[C].real = !0, w = 0, B = v[C].length; B > w; w++)for (b[C][w] = [v[C][w][0]], E = 1, M = v[C][w].length; M > E; E++)b[C][w][E] = (m[C][w][E] - v[C][w][E]) / x; else {
                                    var z = i.matrix || new g, R = {
                                        _: {transform: L.transform}, getBBox: function () {
                                            return i.getBBox(1)
                                        }
                                    };
                                    v[C] = [z.a, z.b, z.c, z.d, z.e, z.f], se(R, m[C]), m[C] = R._.transform, b[C] = [(R.matrix.a - z.a) / x, (R.matrix.b - z.b) / x, (R.matrix.c - z.c) / x, (R.matrix.d - z.d) / x, (R.matrix.e - z.e) / x, (R.matrix.f - z.f) / x]
                                }
                                break;
                            case"csv":
                                var j = q(l[C])[I](k), D = q(v[C])[I](k);
                                if ("clip-rect" == C)for (v[C] = D, b[C] = [], w = D.length; w--;)b[C][w] = (j[w] - v[C][w]) / x;
                                m[C] = j;
                                break;
                            default:
                                for (j = [][P](l[C]), D = [][P](v[C]), b[C] = [], w = i.paper.customAttributes[C].length; w--;)b[C][w] = ((j[w] || 0) - (D[w] || 0)) / x
                        }
                        var V = l.easing, O = e.easing_formulas[V];
                        if (!O)if (O = q(V).match(st), O && 5 == O.length) {
                            var W = O;
                            O = function (t) {
                        ...
                        if (d = l.start || r.start || +new Date, _ = {
                                ...
                                origin: i.attr(),
                                totalOrigin: s
                            }, Ne.push(_), a && !h && !u && (_.stop = !0, _.start = new Date - x * a, 1 == Ne.length))return Me();
                        u && (_.start = new Date - _.ms * a), 1 == Ne.length && Ee(Me)
                    }
            ...
            var w, k = /[, ]+/, B = {
                ...
                doc: document,
                win: window
            }, N = {was: Object.prototype[T].call(A.win, "Raphael"), is: A.win.Raphael}, E = function () {
                this.ca = this.customAttributes = {}
            }, M, L = "appendChild", F = "apply", P = "concat", z = "ontouchstart" in A.win || A.win.DocumentTouch && A.doc instanceof DocumentTouch, R = "", j = " ", q = String, I = "split", D = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[I](j), V = {
                mousedown: "touchstart",
                mousemove: "touchmove",
                mouseup: "touchend"
            }, O = q.prototype.toLowerCase, W = Math, Y = W.max, G = W.min, H = W.abs, X = W.pow, U = W.PI, $ = "number", Z = "string", Q = "array", J = "toString", K = "fill", tt = Object.prototype.toString, et = {}, rt = "push", it = e._ISURL = /^url\(['"]?(.+?)['"]?\)$/i, nt = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i, at = {
                NaN: 1,
                Infinity: 1,
                "-Infinity": 1
            }, st = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/, ot = W.round, lt = "setAttribute", ht = parseFloat, ut = parseInt, ct = q.prototype.toUpperCase, ft = e._availableAttrs = {
                "arrow-end": "none",
                "arrow-start": "none",
                blur: 0,
            ...
            e.svg = !(e.vml = "VML" == e.type), e._Paper = E, e.fn = M = E.prototype = e.prototype, e._id = 0, e._oid = 0, e.is = function (t, e) {
            ...
            var Ft = e.createUUID = function (t, e) {
                ...
                var e = 16 * W.random() | 0, r = "x" == t ? e : 3 & e | 8;
            ...
            e.color = function (t) {
                ...
                var n, a, s, o, l;
                return t = t % 360 / 60, l = r * e, o = l * (1 - H(t % 2 - 1)), n = a = s = r - l, t = ~~t, n += [l, o, 0, 0, o, l][t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], It(n, a, s, i)
            }, e.hsl2rgb = function (t, e, r, i) {
                this.is(t, "object") && "h" in t && "s" in t && "l" in t && (r = t.l, e = t.s, t = t.h), (t > 1 || e > 1 || r > 1) && (t /= 360, e /= 100, r /= 100), t *= 360;
                var n, a, s, o, l;
                return t = t % 360 / 60, l = 2 * e * (.5 > r ? r : 1 - r), o = l * (1 - H(t % 2 - 1)), n = a = s = r - l / 2, t = ~~t, n += [l, o, 0, 0, o, l][t], a += [o, l, l, o, 0, 0][t], s += [0, 0, o, l, l, o][t], It(n, a, s, i)
            }, e.rgb2hsb = function (t, e, r) {
                r = qt(t, e, r), t = r[0], e = r[1], r = r[2];
                var i, n, a, s;
                return a = Y(t, e, r), s = a - G(t, e, r), i = 0 == s ? null : a == t ? (e - r) / s : a == e ? (r - t) / s + 2 : (t - e) / s + 4, i = (i + 360) % 6 * 60 / 360, n = 0 == s ? 0 : s / a, {
                    h: i,
                    s: n,
                    b: a,
                    toString: zt
                ...
                r = qt(t, e, r), t = r[0], e = r[1], r = r[2];
                var i, n, a, s, o, l;
                return s = Y(t, e, r), o = G(t, e, r), l = s - o, i = 0 == l ? null : s == t ? (e - r) / l : s == e ? (r - t) / l + 2 : (t - e) / l + 4, i = (i + 360) % 6 * 60 / 360, a = (s + o) / 2, n = 0 == l ? 0 : .5 > a ? l / (2 * a) : l / (2 - 2 * a), {
                    h: i,
                    s: n,
                    l: a,
                    toString: Rt
            ...
            e.getRGB = n(function (t) {
                ...
                return u ? (u[2] && (s = ut(u[2].substring(5), 16), n = ut(u[2].substring(3, 5), 16), i = ut(u[2].substring(1, 3), 16)), u[3] && (s = ut((l = u[3].charAt(3)) + l, 16), n = ut((l = u[3].charAt(2)) + l, 16), i = ut((l = u[3].charAt(1)) + l, 16)), u[4] && (h = u[4][I](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), "rgba" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100)), u[5] ? (h = u[5][I](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), ("deg" == h[0].slice(-3) || "°" == h[0].slice(-1)) && (i /= 360), "hsba" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100), e.hsb2rgb(i, n, s, o)) : u[6] ? (h = u[6][I](gt), i = ht(h[0]), "%" == h[0].slice(-1) && (i *= 2.55), n = ht(h[1]), "%" == h[1].slice(-1) && (n *= 2.55), s = ht(h[2]), "%" == h[2].slice(-1) && (s *= 2.55), ("deg" == h[0].slice(-3) || "°" == h[0].slice(-1)) && (i /= 360), "hsla" == u[1].toLowerCase().slice(0, 4) && (o = ht(h[3])), h[3] && "%" == h[3].slice(-1) && (o /= 100), e.hsl2rgb(i, n, s, o)) : (u = {
                    r: i,
                    g: n,
                    b: s,
                    toString: a
                ...
                return e.is(t, Q) && e.is(t[0], Q) && (n = Wt(t)), n.length || q(t).replace(yt, function (t, e, r) {
                ...
                }), n.toString = e._path2string, r.arr = Wt(n), n
            }, e.parseTransformString = n(function (t) {
                if (!t)return null;
                var r = {r: 3, s: 4, t: 2, m: 6}, i = [];
                return e.is(t, Q) && e.is(t[0], Q) && (i = Wt(t)), i.length || q(t).replace(mt, function (t, e, r) {
                    var n = [], a = O.call(e);
            ...
            e.findDotsAtSegment = function (t, e, r, i, n, a, s, o, l) {
                var h = 1 - l, u = X(h, 3), c = X(h, 2), f = l * l, p = f * l, d = u * t + 3 * c * l * r + 3 * h * l * l * n + p * s, g = u * e + 3 * c * l * i + 3 * h * l * l * a + p * o, x = t + 2 * l * (r - t) + f * (n - 2 * r + t), v = e + 2 * l * (i - e) + f * (a - 2 * i + e), y = r + 2 * l * (n - r) + f * (s - 2 * n + r), m = i + 2 * l * (a - i) + f * (o - 2 * a + i), b = h * t + l * r, _ = h * e + l * i, w = h * n + l * s, k = h * a + l * o, B = 90 - 180 * W.atan2(x - y, v - m) / U;
            ...
            var Ot = e.pathBBox = function (t) {
                ...
                var c = G[F](0, a), f = G[F](0, s), p = Y[F](0, a), d = Y[F](0, s), g = p - c, x = d - f, v = {
                    x: c,
                    y: f,
                    x2: p,
                    y2: d,
                ...
                var c = 120 * U / 180, f = U / 180 * (+a || 0), p = [], d, g = n(function (t, e, r) {
                    var i = t * W.cos(r) - e * W.sin(r), n = t * W.sin(r) + e * W.cos(r);
                    return {x: i, y: n}
                });
                if (u)S = u[0], T = u[1], B = u[2], C = u[3]; else {
                    d = g(t, e, -f), t = d.x, e = d.y, d = g(l, h, -f), l = d.x, h = d.y;
                    var x = W.cos(U / 180 * a), v = W.sin(U / 180 * a), y = (t - l) / 2, m = (e - h) / 2, b = y * y / (r * r) + m * m / (i * i);
                    b > 1 && (b = W.sqrt(b), r = b * r, i = b * i);
                    var _ = r * r, w = i * i, k = (s == o ? -1 : 1) * W.sqrt(H((_ * w - _ * m * m - w * y * y) / (_ * m * m + w * y * y))), B = k * r * m / i + (t + l) / 2, C = k * -i * y / r + (e + h) / 2, S = W.asin(((e - C) / i).toFixed(9)), T = W.asin(((h - C) / i).toFixed(9));
                    S = B > t ? U - S : S, T = B > l ? U - T : T, 0 > S && (S = 2 * U + S), 0 > T && (T = 2 * U + T), o && S > T && (S -= 2 * U), !o && T > S && (T -= 2 * U)
                }
                var A = T - S;
                if (H(A) > c) {
                    var N = T, E = l, M = h;
                    T = S + c * (o && T > S ? 1 : -1), l = B + r * W.cos(T), h = C + i * W.sin(T), p = Ut(l, h, r, i, a, 0, o, E, M, [T, N, B, C])
                }
                A = T - S;
                var L = W.cos(S), F = W.sin(S), z = W.cos(T), R = W.sin(T), j = W.tan(A / 4), q = 4 / 3 * r * j, D = 4 / 3 * i * j, V = [t, e], O = [t + q * F, e - D * L], Y = [l + q * R, h - D * z], G = [l, h];
                ...
                var l = n - 2 * r + t - (s - 2 * n + r), h = 2 * (r - t) - 2 * (n - r), u = t - r, c = (-h + W.sqrt(h * h - 4 * l * u)) / 2 / l, f = (-h - W.sqrt(h * h - 4 * l * u)) / 2 / l, p = [e, o], d = [t, s], g;
                ...
                for (var i = Gt(t), n = e && Gt(e), a = {
                    ...
                    t && e && "M" == t[s][0] && "M" != e[s][0] && (e.splice(s, 0, ["M", a.x, a.y]), r.bx = 0, r.by = 0, r.x = t[s][1], r.y = t[s][2], g = Y(i.length, n && n.length || 0))
                }, u = [], c = [], f = "", p = "", d = 0, g = Y(i.length, n && n.length || 0); g > d; d++) {
            ...
            }, null, Wt), Jt = e._parseDots = n(function (t) {
                ...
                if (h.transform = i || [], i)for (var c = 0, f = i.length; f > c; c++) {
                    var p = i[c], d = p.length, x = q(p[0]).toLowerCase(), v = p[0] != x, y = v ? u.invert() : 0, m, b, _, w, k;
                ...
                r = q(r).replace(/\.{3}|\u2026/g, t), t = e.parseTransformString(t) || [], r = e.parseTransformString(r) || [];
                for (var i = Y(t.length, r.length), n = [], a = [], s = 0, o, l, h, u; i > s; s++) {
                    if (h = t[s] || oe(r[s]), u = r[s] || oe(h), h[0] != u[0] || "r" == h[0].toLowerCase() && (h[2] != u[2] || h[3] != u[3]) || "s" == h[0].toLowerCase() && (h[3] != u[3] || h[4] != u[4]))return;
                    for (n[s] = [], a[s] = [], o = 0, l = Y(h.length, u.length); l > o; o++)o in h && (n[s][o] = h[o]), o in u && (a[s][o] = u[o])
                }
                return {from: n, to: a}
            };
            e._getContainer = function (t, r, i, n) {
            ...
            }, e.pathToRelative = Yt, e._engine = {}, e.path2curve = Qt, e.matrix = function (t, e, r, i, n, a) {
                ...
                t.add = function (t, e, r, i, n, a) {
                    ...
                    var n = +W.cos(t).toFixed(9), a = +W.sin(t).toFixed(9);
                    ...
                    t.scalex = W.sqrt(r(n[0])), i(n[0]), t.shear = n[0][0] * n[1][0] + n[0][1] * n[1][1], n[1] = [n[1][0] - n[0][0] * t.shear, n[1][1] - n[0][1] * t.shear], t.scaley = W.sqrt(r(n[1])), i(n[1]), t.shear /= t.scaley;
                    var a = -n[0][1], s = n[1][1];
                    return 0 > s ? (t.rotate = e.deg(W.acos(s)), 0 > a && (t.rotate = 360 - t.rotate)) : t.rotate = e.deg(W.asin(a)), t.isSimple = !(+t.shear.toFixed(9) || t.scalex.toFixed(9) != t.scaley.toFixed(9) && t.rotate), t.isSuperSimple = !+t.shear.toFixed(9) && t.scalex.toFixed(9) == t.scaley.toFixed(9) && !t.rotate, t.noRotation = !+t.shear.toFixed(9) && !t.rotate, t
            ...
            ye.drag = function (r, i, n, a, s, o) {
                function l(l) {
                    ...
                    if (this._drag.id = l.identifier, z && l.touches)for (var p = l.touches.length, d; p--;)if (d = l.touches[p], this._drag.id = d.identifier, d.identifier == this._drag.id) {
            ...
            M.getElementByPoint = function (t, e) {
                ...
                var e = this._;
                return t ? (!e.dirty && e.bboxwt || (this.realPath = Nt[this.type](this), e.bboxwt = Ot(this.realPath), e.bboxwt.toString = v, e.dirty = 0), e.bboxwt) : ((e.dirty || e.dirtyT || !e.bbox) && (!e.dirty && this.realPath || (e.bboxwt = 0, this.realPath = Nt[this.type](this)), e.bbox = Ot(Et(this.realPath, this.matrix)), e.bbox.toString = v, e.dirty = e.dirtyT = 0), e.bbox)
            }, ye.clone = function () {
                ...
                var e = {
                    ...
                    offsety: t.offsety || 0,
                    color: t.color || "#000"
                }, r = e.width / 2, i = this.paper, n = i.set(), a = this.realPath || Nt[this.type](this);
            ...
            var Ae = e.easing_formulas = {
                linear: function (t) {
                    ...
                    var e = .48 - t / 1.04, r = W.sqrt(.1734 + e * e), i = r - e, n = X(H(i), 1 / 3) * (0 > i ? -1 : 1), a = -r - e, s = X(H(a), 1 / 3) * (0 > a ? -1 : 1), o = n + s + .5;
                    ...
                    return t == !!t ? t : X(2, -10 * t) * W.sin((t - .075) * (2 * U) / .3) + 1
                }, bounce: function (t) {
            ...
            var Ne = [], Ee = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) {
                    setTimeout(t, 16)
                }, Me = function () {
                for (var r = +new Date, i = 0; i < Ne.length; i++) {
                    ...
                    if (!n.el.removed && !n.paused) {
                        ...
                        if (n.initstatus ? (a = (n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev) * s, n.status = n.initstatus, delete n.initstatus, n.stop && Ne.splice(i--, 1)) : n.status = (n.prev + (n.percent - n.prev) * (a / s)) / n.anim.top, !(0 > a))if (s > a) {
                            var v = o(a / s);
                            ...
                            if (function (r, i, n) {
                                ...
                                }(n.callback, f, n.anim), f.attr(u), Ne.splice(i--, 1), n.repeat > 1 && !n.next) {
            ...
            ye.animateWith = function (t, r, i, n, a, s) {
                ...
                for (var c = 0, f = Ne.length; f > c; c++)if (Ne[c].anim == r && Ne[c].el == t) {
                ...
                for (n = Ne.length; n > i; i++)if (a = Ne[i], a.el.id == this.id && (!t || a.anim == t)) {
                    if (t)return a.status;
                    r.push({anim: a.anim, status: a.status})
                }
                return t ? 0 : r
            }, ye.pause = function (e) {
                for (var r = 0; r < Ne.length; r++)Ne[r].el.id != this.id || e && Ne[r].anim != e || t("raphael.anim.pause." + this.id, this, Ne[r].anim) !== !1 && (Ne[r].paused = !0);
                return this
                ...
                for (var r = 0; r < Ne.length; r++)Ne[r].el.id != this.id || e && Ne[r].anim != e || t("raphael.anim.stop." + this.id, this, Ne[r].anim) !== !1 && Ne.splice(r--, 1);
                return this
            }, t.on("raphael.remove", _), t.on("raphael.clear", _), ye.toString = function () {
                return "Raphaël’s object"
            };
            var Fe = function (t) {
                if (this.items = [], this.length = 0, this.type = "set", t)for (var e = 0, r = t.length; r > e; e++)!t[e] || t[e].constructor != ye.constructor && t[e].constructor != Fe || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++)
            }, Pe = Fe.prototype;
            Pe.push = function () {
                for (var t, e, r = 0, i = arguments.length; i > r; r++)t = arguments[r], !t || t.constructor != ye.constructor && t.constructor != Fe || (e = this.items.length, this[e] = this.items[e] = t, this.length++);
                return this
            }, Pe.pop = function () {
            ...
            for (var ze in ye)ye[T](ze) && (Pe[ze] = function (t) {
                return function () {
                    var e = arguments;
            ...
            return Pe.attr = function (t, r) {
                ...
                t = 0 > t ? Y(this.length + t, 0) : t, e = Y(0, G(this.length - t, e));
                var i = [], n = [], a = [], s;
                ...
                return t = G[F](0, t), e = G[F](0, e), r = Y[F](0, r), i = Y[F](0, i), {
                    x: t,
                    y: e,
                    x2: r,
                    y2: i,
                ...
                var h = q(i)[I](R), u = 0, c = 0, f = R, p;
                if (e.is(n, "string") && (n = this.getFont(n)), n) {
                    p = (a || 16) / n.face["units-per-em"];
                    for (var d = n.face.bbox[I](k), g = +d[0], x = d[3] - d[1], v = 0, y = +d[1] + ("baseline" == s ? x + +n.face.descent : x / 2), m = 0, b = h.length; b > m; m++) {
                ...
                if (N.was)A.win.Raphael = N.is; else {
        ...
        i = [r(1)], n = function (t) {
            if (!t || t.svg) {
                ...
                var x = function (i, n) {
                    ...
                    if ("path" == i.type) {
                        ...
                        if ("open" == v ? (k += 2, B += 2, C += 2, b = 1, _ = a ? 4 : 1, w = {
                            ...
                            var A = t._g.doc.getElementById(T), N;
                            A ? (g[T]++, N = A.getElementsByTagName("use")[0]) : (A = x(x("marker"), {
                                id: T,
                                markerHeight: B,
                                markerWidth: k,
                                orient: "auto",
                            ...
                            }), A.appendChild(N), o.defs.appendChild(A), g[T] = 1), x(N, w);
                            var E = b * ("diamond" != v && "oval" != v);
                            a ? (y = i._.arrows.startdx * f || 0, m = t.getTotalLength(u.path) - E * f) : (y = E * f, m = t.getTotalLength(u.path) - (i._.arrows.enddx * f || 0)), w = {}, w["marker-" + l] = "url(#" + T + ")", (m || y) && (w.d = t.getSubpath(u.path, y, m)), x(h, w), i._.arrows[l + "Path"] = S, i._.arrows[l + "Marker"] = T, i._.arrows[l + "dx"] = E, i._.arrows[l + "Type"] = v, i._.arrows[l + "String"] = n
                    ...
                    for (var d in a)if (a[e](d)) {
                        ...
                        switch (u[d] = g, d) {
                            ...
                            case"stroke":
                                F = t.getRGB(g), l.setAttribute(d, F.hex), "stroke" == d && F[e]("opacity") && x(l, {"stroke-opacity": F.opacity > 1 ? F.opacity / 100 : F.opacity}), "stroke" == d && i._.arrows && ("startString" in i._.arrows && _(i, i._.arrows.startString), "endString" in i._.arrows && _(i, i._.arrows.endString, 1));
                                break;
                            case"gradient":
                            ...
                            case"fill-opacity":
                                if (u.gradient) {
                                    P = t._g.doc.getElementById(l.getAttribute("fill").replace(/^url\(#|\)$/g, c)), P && (z = P.getElementsByTagName("stop"), x(z[z.length - 1], {"stop-opacity": g}));
                                    break
                                }
                            default:
                    ...
                    var i = 0, n = 0;
                    this[0] = this.node = e, e.raphael = !0, this.id = t._oid++, e.raphaelid = this.id, this.matrix = t.matrix(), this.realPath = null,
                        this.paper = r, this.attrs = this.attrs || {}, this._ = {
                        transform: [],
                        sx: 1,
                        sy: 1,
                        deg: 0,
                ...
                A.prototype = N, N.constructor = A, t._engine.path = function (t, e) {
                    var r = x("path");
                ...
                var E = t.st;
                for (var M in N)N[e](M) && !E[e](M) && (E[M] = function (t) {
                    return function () {
                        var e = arguments;
                        return this.forEach(function (r) {
                            r[t].apply(r, e)
            ...
            if (!t || t.vml) {
                ...
                var S = function (t, e, i) {
                    ...
                    if (v && (f.path = t._getPath[n.type](n), n._.dirty = 1), l.href && (c.href = l.href), l.title && (c.title = l.title), l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor), "blur" in l && n.blur(l.blur), (l.path && "path" == n.type || v) && (c.path = k(~r(f.path).toLowerCase().indexOf("r") ? t._pathToAbsolute(f.path) : f.path), n._.dirty = 1, "image" == n.type && (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height], C(n, 1, 1, 0, 0, 0))), "transform" in l && n.transform(l.transform), y) {
                        var T = +f.cx, N = +f.cy, E = +f.rx || +f.r || 0, L = +f.ry || +f.r || 0;
                        c.path = t.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", a((T - E) * b), a((N - L) * b), a((T + E) * b), a((N + L) * b), a(T * b)), n._.dirty = 1
                    }
                    if ("clip-rect" in l) {
                        var F = r(l["clip-rect"]).split(u);
                        if (4 == F.length) {
                            F[2] = +F[2] + +F[0], F[3] = +F[3] + +F[1];
                            var P = c.clipRect || t._g.doc.createElement("div"), z = P.style;
                            z.clip = t.format("rect({1}px {2}px {3}px {0}px)", F), c.clipRect || (z.position = "absolute", z.top = 0, z.left = 0, z.width = n.paper.width + "px", z.height = n.paper.height + "px", c.parentNode.insertBefore(P, c), P.appendChild(c), c.clipRect = P)
                        }
                    ...
                    if ("arrow-start" in l && S(m, l["arrow-start"]), "arrow-end" in l && S(m, l["arrow-end"], 1), null != l.opacity || null != l["stroke-width"] || null != l.fill || null != l.src || null != l.stroke || null != l["stroke-width"] || null != l["stroke-opacity"] || null != l["fill-opacity"] || null != l["stroke-dasharray"] || null != l["stroke-miterlimit"] || null != l["stroke-linejoin"] || null != l["stroke-linecap"]) {
                        var j = c.getElementsByTagName(h), q = !1;
                        if (j = j && j[0], !j && (q = j = M(h)), "image" == n.type && l.src && (j.src = l.src), l.fill && (j.on = !0), null != j.on && "none" != l.fill && null !== l.fill || (j.on = !1), j.on && l.fill) {
                            var I = r(l.fill).match(t._ISURL);
                            if (I) {
                                j.parentNode == c && c.removeChild(j), j.rotate = !0, j.src = I[1], j.type = "tile";
                                var D = n.getBBox(1);
                                j.position = D.x + p + D.y, n._.fillpos = [D.x, D.y], t._preload(I[1], function () {
                                ...
                                circle: 1,
                                ellipse: 1
                            } || "r" != r(l.fill).charAt()) && A(m, l.fill, j) && (f.fill = "none", f.gradient = l.fill, j.rotate = !1)
                        }
                        ...
                        c.appendChild(j);
                        var O = c.getElementsByTagName("stroke") && c.getElementsByTagName("stroke")[0], W = !1;
                        !O && (W = O = M("stroke")), (l.stroke && "none" != l.stroke || l["stroke-width"] || null != l["stroke-opacity"] || l["stroke-dasharray"] || l["stroke-miterlimit"] || l["stroke-linejoin"] || l["stroke-linecap"]) && (O.on = !0), ("none" == l.stroke || null === l.stroke || null == O.on || 0 == l.stroke || 0 == l["stroke-width"]) && (O.on = !1);
                        var Y = t.getRGB(l.stroke);
                        O.on && l.stroke && (O.color = Y.hex), V = ((+f["stroke-opacity"] + 1 || 2) - 1) * ((+f.opacity + 1 || 2) - 1) * ((+Y.o + 1 || 2) - 1);
                ...
                }, E.auxGetBBox = t.el.getBBox, E.getBBox = function () {
                ...
                var L = t.st;
                for (var F in E)E[e](F) && !L[e](F) && (L[F] = function (t) {
                    return function () {
                        var e = arguments;
                        return this.forEach(function (r) {
                            r[t].apply(r, e)
