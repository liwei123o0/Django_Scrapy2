(function (g) {
    ...
    h.Client.prototype = {
        ...
        receiveEvent: function (a, b) {
            ...
            if (this.handlers[a])for (var c =
                ...
                if ("function" == typeof f)f(this, b); else if ("object" == typeof f && 2 == f.length)f[0][f[1]](this, b); else if ("string" == typeof f)i[f](this, b)
            }
        }
    };
    h.hasFlash = function () {
    ...
    j.ext.buttons.excelFlash = g.extend({}, s, {
        ...
        text: function (a) {
            ...
            var a = c._flash, e = 0, f = g.parseXML(p["xl/worksheets/sheet1.xml"]), h = f.getElementsByTagName("sheetData")[0], d = {
                ...
                i, k, j = function (a) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        ...
                        "number" === typeof a[b] || a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !g.trim(a[b]).match(/^0\d+/) ? d = l(f, "c", {
                            ...
                            children: {row: l(f, "is", {children: {row: l(f, "t", {text: j})}})}
                        }));
                        k.appendChild(d)
                    }
                    h.appendChild(k);
            ...
            for (n = b.header.length; m < n; m++)j.appendChild(l(f,
                "col", {attr: {min: m + 1, max: m + 1, width: y(b, m), customWidth: 1}}));
